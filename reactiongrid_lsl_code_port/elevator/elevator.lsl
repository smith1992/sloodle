// LSL script generated: avatar_classroom2.reactiongrid_lsl_code_port.elevator.elevator.lslp Wed Aug 18 19:07:06 Pacific Daylight Time 2010
/*********************************************
...
key k(string kk){
 ...
 default {
    ...
    state_entry() {
        ...
        string desc = llGetObjectName();
        (floorName = ("Floor " + llGetSubString(desc,8,8)));
        (floorNum = ((integer)llGetSubString(desc,8,8)));
