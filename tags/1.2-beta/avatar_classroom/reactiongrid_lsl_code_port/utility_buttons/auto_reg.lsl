// LSL script generated: avatar_classroom2.reactiongrid_lsl_code_port.utility_buttons.auto_reg.lslp Wed Aug 18 19:07:06 Pacific Daylight Time 2010
//reset
...
state ready {
    ...
    touch_start(integer num_detected) {
        ...
        else  if ((desc == "btn:btn_autoreg_off")) {
            llSetTimerEvent(0.25);
    ...
    link_message(integer sender_num,integer channel,string str,key id) {
        if ((channel == SLOODLE_CHANNEL_OBJECT_DIALOG)) {
            ...
            if ((response == "course->checkAutoEnrolSettings")) {
                ...
                else  if ((((integer)status) == ((integer)-516))) {
                    llSetTexture("error",4);
