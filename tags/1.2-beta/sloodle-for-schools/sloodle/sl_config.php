...
//---------------------------------------------------------------------
    ...
    // In conventioanl SLOODLE, each course needs to have at least one Sloodle Access Controller before it can be accessed from in-world.
    // This is what grants access to the course as a whole, and sets prim passwords.
    // It is not used in SLOODLE for Schools, but the identifier remains here so the code doesn't break.
