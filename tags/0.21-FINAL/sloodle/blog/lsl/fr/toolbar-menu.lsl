//////////
//
// Sloodle Toolbar menu script (v2.0) (French version)
...
string HELP_NOTECARD = "Sloodle Toolbar v1.3 Aide";
...
list animdata = [   "gesture:handup", "LongRaise", "lève la main.", 0,
                    "gesture:wave", "Wave", "salue.", 0,
                    "gesture:clap", "clap", "applaudit.", -1,
                    "gesture:nodoff", "Nodoff", "s'endort.", -1,
                    "gesture:huh", "IDontUnderstand", "se gratte le tete.", -1,
                    "gesture:gotit", "gotit", "a compris!", -1,
                    "gesture:yes", "Yes", "dit oui.", -1,
                    "gesture:no", "No", "dit non.", -1
                ];
    ...
    touch_start(integer total_number)
    {
        ...
        if (name == llGetObjectName()) {
            ...
            if (llGetInventoryType(HELP_NOTECARD) == INVENTORY_NOTECARD) {
                ...
                // Nothing to give
                llOwnerSay("Impossible d'apporter une aide - la notecard \"" + HELP_NOTECARD + "\" est introuvable dans l'inventaire.");
            }
            return;
        }
