...
// Allow the specified avatar through
send_permit_message(key id)
{
    llMessageLinked(LINK_SET,SLOODLE_CHANNEL_OBJECT_ACCESS_CHECKER_PERMIT,"do:permitentry|"+(string)id,NULL_KEY);
}
