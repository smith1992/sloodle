...
list locstrings = [
    ...
    "chatbody", "Please chat the body text of your blog entry. You can use multiple chat messages, up to a total of {{0}} characters.", // Parameter: maximum number of characters
