...
key httpquizquery = NULL_KEY; // = null_key; for OpenSim
...
key toucher = NULL_KEY; // = null_key; for OpenSim
...
send_answers()
{
    ...
    for (i=0; i<llGetListLength(opids_current); i++) {
...
state quizzing
{
    ...
    http_response(key request_id, integer status, list metadata, string body)
    {
        ...
        // Go through each line of the response
        //list thisline = [];  // deleted for OpenSim
        //string rowtype = ""; // deleted for OpenSim
        integer i = 0;
