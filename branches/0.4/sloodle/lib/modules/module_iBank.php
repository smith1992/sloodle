<?php
    ...
    /**
    * This file defines the Sloodle iBank module.
    *
    * @package sloodle
    ...
    * @package sloodle
    */
    class SloodleModuleiBank extends SloodleModule
    {
    // DATA //
    ...
    */
    ...
    // ACCESSORS //
        ...
        */
        ...
        {
            return get_string('moduletype:'.SLOODLE_TYPE_IBANK, 'sloodle');
        }
