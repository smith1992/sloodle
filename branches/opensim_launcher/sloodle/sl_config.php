...
//---------------------------------------------------------------------    
    ...
    define('SLOODLE_VERSION', '1.0.2-OSL'); // This is the release version, not the module version (which is in version.php)
...
//---------------------------------------------------------------------
	...
	define('SLOODLE_TYPE_TRACKER', 'tracker'); //** NEW **//
	...
	$SLOODLE_TYPES[] = SLOODLE_TYPE_TRACKER; //** NEW **// 
