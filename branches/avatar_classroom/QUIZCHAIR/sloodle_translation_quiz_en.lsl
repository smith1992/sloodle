...
list locstrings = ["invalidchoice","Sorry {{0}}. Your selection was not in the list of available choices. Please try again.","invalidtype","Error: this object cannot handle quiz questions of type: {{0}}","complete","Quiz complete {{0}}. Your final score was {{1}}.","repeating","Repeating...","starting","Starting quiz for {{0}}","noquestions","ERROR: there are no questions available","notenrolled","ERROR:  It appears you are not enrolled in this class.  Please make sure you are enrolled AND your avatar is linked to your Moodle account.","noattemptsleft","Sorry {{0}}. You are not allowed to attempt this quiz again.","fetchingquiz","Fetching quiz data...","joinattempt","Attempting to join the game...","gamejoined","Join successful!","waitforconfig","Please wait until chair completes its configuration stage.","ready","Ready to attempt: {{0}}.","correct","Correct {{0}}.","usedialogs","Error: You attempted to answer a multiple choice, or a true/false answer by typing on the chat line instead of using the dialog {{0}}.","incorrect","Incorrect {{0}}."];
