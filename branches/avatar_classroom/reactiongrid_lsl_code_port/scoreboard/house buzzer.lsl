// LSL script generated: avatar_classroom2.reactiongrid_lsl_code_port.scoreboard.house buzzer.lslp Wed Aug 25 13:52:43 Pacific Daylight Time 2010
/*********************************************
...
string SHOWARM = "HIDE";
integer USAGE_CHANNEL = -92112311;
list winners;
list winnerKeys;
list sitters;
list booths;
...
state ready {
    ...
    touch_start(integer num_detected) {
        ...
        if (isFacilitator(llDetectedName(0))) {
            llMessageLinked(LINK_SET,USAGE_CHANNEL,"COMMAND:REPORT",llDetectedKey(0));
            ...
            if ((butName == "hide_arm_button")) {
                ...
                llTriggerSound("cf218344-0251-6bfd-acba-fdd5534861b1",1.0);
                llMessageLinked(LINK_SET,UI_CHANNEL,"cmd:reset points",NULL_KEY);
                (winners = []);
                return;
            }
            ...
            if ((SHOWARM == "SHOW")) {
                ...
                if ((llListFindList(winners,[userName]) == (-1))) {
                    ...
                    if ((numWinners < 4)) {
                        ...
                        if ((numWinners == 1)) {
                            (printChannel = XY_1);
                            llMessageLinked(LINK_SET,UI_CHANNEL,(("cmd:RowEntry|username:" + userName) + "|row:0"),userKey);
                            (anim = "p3");
                        }
                            ...
                            (printChannel = XY_3);
                            llMessageLinked(LINK_SET,UI_CHANNEL,(("cmd:RowEntry|username:" + userName) + "|row:2"),userKey);
                            (anim = "p5");
                        }
