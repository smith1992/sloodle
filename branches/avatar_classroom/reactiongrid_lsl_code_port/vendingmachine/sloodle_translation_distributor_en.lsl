// LSL script generated: avatar_classroom2.reactiongrid_lsl_code_port.vendingmachine.sloodle_translation_distributor_en.lslp Wed Aug 25 13:52:43 Pacific Daylight Time 2010
...
list locstrings = ["openingxmlrpc","Opening XMLRPC channel...","establishingconnection","Establishing connection with outside server...","dialog:distributorcommandmenu","Sloodle Distributor.\nSelect an action:\n\n{{0}} = Reconnect\n{{1}} = Reset\n{{2}} = Shutdown","dialog:distributorobjectmenu","Sloodle Distributor.\n\n{{0}}","dialog:distributorobjectmenu:cmd","Sloodle Distributor.\n\n{{0}}{{1}} = Command menu\n{{2}} = Visit Distributer on MOODLE","dialog:distributorobjectmenu:visitmoodle","Click \"Go to page\" to visit the distributer on MOODLE","distributor:notconnected","The distributer is currently not connected, or is shut down.  So we can not redirect you to the webpage for this distributer."];
