                ...
                //initialize rows we store                                                     
                    ...
                    for (counter=0;counter<len;counter++){
                            ...
                            if (awardId==selectedAwardId){
                                //highlight row
                                //llMessageLinked(LINK_SET,PRIM_PROPERTIES_CHANNEL,"COMMAND:HIGHLIGHT|ROW:"+(string)counter+"|POWER:ON|COLOR:GREEN",SCRIPT_NAME);
           ...
           /*****************************************************************
             ...
             *****************************************************************/           
             if (response=="awards|addAwardGrp"){
                ...
                *********************************/
                if (response=="awards|getPlayerTeamScores"){
                    //clear hovertext
