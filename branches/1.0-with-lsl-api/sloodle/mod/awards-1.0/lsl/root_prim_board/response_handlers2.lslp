     ...
     listen(integer channel, string name, key id, string str) {   
           ...
           if ((channel >=ROW_CHANNEL) && (channel <= ROW_CHANNEL+10)){  
                ...
                if (str=="~~ SAVE ~~"){
                    ...
                    ****************************************************************************************************/
                   list user = llList2List(rows_getClassList, rowNum* 4, rowNum* 4 + 3); 
                    //llSay(0,llGetScriptName()+" Modifying user: "+llList2CSV(user));
                    //llSay(0,llGetScriptName()+" Row num is: "+(string)rowNum+" "+llList2CSV(user));                
                    ...
                    //llSay(0,llGetScriptName()+" Points: "+(string)points+" "+llList2CSV(user));    
