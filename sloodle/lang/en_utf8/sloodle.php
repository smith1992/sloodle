...
$string['wallet:view'] = 'View Wallets'; 
$string['wallet:avname'] = 'Avatar'; 
$string['wallet:currency'] = 'Currency'; 
$string['wallet:type'] = 'Type'; 
$string['wallet:time'] = 'Time'; 
$string['wallet:username'] = 'User name';
$string['wallet:nocurrency'] = 'No Currency Transactions Exist';
$string['wallet:gold'] = 'Gold';
$string['wallet:silver'] = 'Silver';
$string['wallet:bronze'] = 'Bronze';
$string['wallet:credits'] = 'Credits';
$string['wallet:magic'] = 'Magic';
$string['wallet:hit'] = 'Hit';
$string['wallet:health'] = 'Health';
$string['wallet:damage'] = 'Damage';
$string['wallet:power'] = 'Power';
$string['wallet:food'] = 'Food';
$string['wallet:ore'] = 'Ore';
$string['wallet:wood'] = 'Wood';
$string['wallet:metal'] = 'Precious Metal';
$string['wallet:points'] = 'Points';
$string['wallet:rations'] = 'Rations';
$string['wallet:units'] = 'Units';
$string['wallet:coins'] = 'Coins';
$string['wallet:amount'] = 'Amount';
