...
$string['object:ibank'] = 'Stipend Giver';
...
$string ['ibank:stipendisfor']= 'Total Allocations:';
$string ['ibank:purpose']= 'It\'s purpose is: ';
$string ['ibank:nostipendsgiven'] = 'No stipends have been taken by anyone yet!';   
$string ['ibank:description'] = 'Description';
$string ['ibank:transactions'] = 'Transactions & Allocated Stipends';   
$string ['ibank:noavatar'] = 'No Avatar Registered'; 
$string ['ibank:avname'] = 'Avatar Name'; 
$string ['ibank:alloted'] = 'Allotted'; 
$string ['ibank:withdrawn'] = 'Withdrawn'; 
$string ['ibank:selectstipend'] ="Please select the course stipend this in world object one connects to";
$string ['ibank:nostpendgivers'] = 'No stipend givers have been added to your moodle course.  Please add a stipend giver activity first.';
$string ['ibank:date'] = 'Date';
$string ['ibank:teachers'] = 'Teachers';
$string ['ibank:administrators'] = 'Administrators';

$string ['ibank:students'] = 'Students';
$string ['ibank:noavatarbutalreadywithdrew'] = 'Avatar no longer listed. But debit transaction exists';
$string ['ibank:create'] = 'Add Stipends now!'; 
$string ['ibank:setup'] = 'Click here to create allocate your stipend!';    
$string['ibank:admins']='Administrators';
$string['ibank:students']='Students';
$string['ibank:teachers']='Teachers';
$string['ibank:balance']='Balance';
$string['ibank:credits']='Credits';
$string['ibank:debits']='Debits';
$string['ibank:debits']='Debits';
$string['ibank:avatars']='Avatars';
$string['ibank:username']='First/Last name';
$string['ibank:update']='Update';  
$string['ibank:cantupdate']='Error Can\'t update transaction record';
$string['ibank:successfullupdate']='Updated the following users: ';
$string['ibank:typeofcurrency']='Type of Currency';
$string['ibank:amount']='Amount';
$string['ibank:totalallocations']='Total Allocated';
$string['ibank:totaldebits']='Total Debits';
$string['ibank:startingbalance']='Default Amount';
$string['ibank:alreadywd']=' has already withdrawn the amount of: ';  
$string['ibank:totalipoints']='Total iPoints';
$string['ibank:totalawarded']='Total Awarded';   
$string['ibank:iPoints']='iPoints';    
$string['ibank:id']='id';    
$string['ibank:goback']='Back to full user list';    
$string['ibank:usertransactions']='Transactions for: ';    
$string['ibank:details']='Transaction Details';    
$string['ibank:fullname']='Full Name';    
$string['ibank:course']='Course';    
$string['ibank:scoreboard']='iPoint Scoreboard';                   
$string['ibank:ibankAccountDetails']='iBank Account Details';                   
$string['ibank:ibankBalanceChart']='iBank Statistics';                   
$string['ibank:totalusers']='Total Users:';                   
$string['ibank:totalcredits']='Total Credits:';                   
$string['ibank:totaldebits']='Total Debits:'; 
$string['ibank:totalbalances']='Total Balances:';                                     
$string['ibank:balanceUpdate']='Update';                   
$string['ibank:noneregistered']='No avatars registered in SLOODLE';  
$string['ibank:alreadywd2']=' You can not choose a lower allotment unless that user\'s avatar pays the stipend giver to credit their account'; 
...
$string['ibank:othersettings'] = 'Other Settings';
$string['ibank:refresh'] = 'This is the time in seconds that the ibank will refresh the display in Second Life<br>';
