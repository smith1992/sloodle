...
//ESTE YA ESTABA $string['moduletype:tracker'] = 'tracker';
$string['moduletype:tracker'] = 'Second Life Tracker'; //** NEW **//
...
$string['notrackers'] = 'There are no SLOODLE Second Life Tracker modules avaliable in this course.'; //** NEW **//
...
$string['object:tracker'] = 'Second Life Tracker'; //** NEW **//
...
$string['selecttracker'] = 'Select Second Life Tracker'; //** NEW **//
...
$string['tracker:opensim_template_name'] = 'OpenSim Template name';
$string['tracker:invalidtemplatename'] = 'Invalid template name. Please include only letters, numbers, and underscores.';
$string['tracker:settings'] = 'Tracker Settings';
$string['tracker:templates_folder'] = 'OpenSim Templates folder';
$string['tracker:templates_folder:info'] = 'The path to the OpenSim Templates folder on disk.';
$string['tracker:instances_folder'] = 'OpenSim Instances folder';
$string['tracker:instances_folder:info'] = 'The path to the folder where OpenSim instances will be created.';
$string['tracker:main_opensim_folder'] = 'Main OpenSim Installation folder';
$string['tracker:main_opensim_folder:info'] = 'The path to the folder where main OpenSim is installed.';
$string['tracker:main_opensim_db'] = 'Main OpenSim DataBase name';
$string['tracker:main_opensim_db:info'] = 'The DataBase name of the main OpenSim installation.';
$string['tracker:notconfigured'] = 'Tracker not fully configured. Please ensure all data is supplied in SLOODLE Module configuration screen.';
$string['tracker:opensim_db_host'] = 'OpenSim Database Host';
$string['tracker:opensim_db_host:info'] = 'Server where the OpenSim resides.';
$string['tracker:opensim_db_user'] = 'OpenSim database username';
$string['tracker:opensim_db_user:info'] = 'The database user must have database creation permissions.';
$string['tracker:opensim_db_password'] = 'OpenSim database password';
$string['tracker:opensim_db_password:info'] = 'Password for logging-in to the OpenSim database server.';
$string['tracker:opensim_port_min'] = 'Reserved port (min)';
$string['tracker:opensim_port_min:info'] = 'The start of the block of ports reserved for OpenSim instances.';
$string['tracker:opensim_port_max'] = 'Reserved port (max)';
$string['tracker:opensim_port_max:info'] = 'The end of the block of ports reserved for OpenSim instances.';
$string['tracker:opensim_port_template'] = 'Reserved port (templates)';
$string['tracker:opensim_port_template:info'] = 'The port reserved for OpenSim templates.';
$string['tracker:opensim_address'] = 'OpenSim address';
$string['tracker:opensim_address:info'] = 'Address for accessing the OpenSim server (e.g domain name or IP address)';
$string['tracker:teleport'] = 'Click here to teleport to your OpenSim region';
$string['tracker:teleportTemplate'] = 'Click here to teleport to your OpenSim template';
$string['tracker:teleportNewTemplate'] = 'Click here to teleport to your new OpenSim template';
$string['tracker:opensiminstancecreated'] = 'Your OpenSim instance has been created.';
$string['tracker:opensimtemplatecreated'] = 'Your OpenSim template has been created.';
$string['tracker:instancealreadyallocatedport'] = 'An internal error has occured. The named OpenSim instance already has a port allocated to it.';
$string['tracker:noportsavailable'] = 'Unable to create OpenSim instance. No ports are available. Please try again later.<br /><br />If you are the administrator, then please check that your cron job is running, as this is required to deallocate ports which are no longer being used.';
$string['tracker:updatetemplate'] = 'Update an OpenSim template: ';
$string['tracker:newtemplate'] = 'Create a new OpenSim template: ';
$string['tracker:templatename:info'] = '(name)';

$string['tracker:settingupopensim'] = 'Setting up your OpenSim world...';
$string['tracker:launchopensim'] = 'Click here to launch your OpenSim instance';
$string['tracker:createtemplate'] = 'Click here to create a new OpenSim template';
$string['tracker:managetemplate'] = 'Click here to manage OpenSim templates';
$string['tracker:launchtemplate'] = 'Click here to launch the OpenSim template';
...
$string ['deletetask'] = 'Reset/Delete Task(s)';
// ************************************************************** //
