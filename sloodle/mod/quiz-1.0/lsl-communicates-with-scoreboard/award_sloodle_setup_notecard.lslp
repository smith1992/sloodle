...
string SLOODLE_AWARD_CONFIG_NOTECARD = "sloodle_award_config"; //here is the modification
...
sloodle_start_reading_award_notecard()
{
    ...
    if (llGetInventoryType(SLOODLE_AWARD_CONFIG_NOTECARD) == INVENTORY_NOTECARD) {
        ...
        sloodle_notecard_line = 0;
        sloodle_notecard_key = llGetNotecardLine("sloodle_award_config", 0); // read the first line. The dataserver event will get the next one.
