...
* 
* _sloodle_api_new.lsl
*
*  This script is part of the SLOODLE Project see http://sloodle.org
*  _sloodle_api_new.lsl listens for linked messages from other scripts coming in on the PLUGIN_CHANNEL=998821
*  All messages received will be forwarded to the SLOODLE HQ API module for interpretations
* The SLOODLE HQ API MODULE forwards all messages received to the appropriate API plugins which live in the /sloodle/plugins folder
*  Each plugin will return an http response which will then be forwarded back into Second Life to the _sloodle_api_new.lsl script
* The _sloodle_api_new.lsl script will then post a linked message on the  PLUGIN_RESPONSE_CHANNEL=998822
* _response handler scripts can then be written to interpret and act on the response.
*
*  Copyright:
