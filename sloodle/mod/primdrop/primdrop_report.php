...
$query = 'SELECT 
mdl_sloodle_prim.obj_id,
mdl_sloodle_prim.obj_name,
mdl_sloodle_prim.avi_id,
mdl_sloodle_prim.avi_name,
mdl_sloodle_prim.course,
mdl_sloodle_prim.region,
mdl_sloodle_prim.x,
mdl_sloodle_prim.y,
mdl_sloodle_prim.z,
mdl_sloodle_prim.dropbox_name,
mdl_sloodle_prim.dropbox_id,
mdl_sloodle_prim.obj_type,
mdl_sloodle_prim.prim_count,
mdl_sloodle_prim.timeadded
FROM mdl_sloodle_prim 
WHERE (mdl_sloodle_prim.id=mdl_sloodle_prim.id) 
ORDER BY mdl_sloodle_prim.timeadded DESC';
...
Print "The following objects were dropped:<hr>";


while($messages = mysql_fetch_array($res))
{
Print "<b>";
Print $messages['obj_name'];
Print "</b> (";
Print $messages['obj_id'];
Print ")<br>";
echo userdate($messages['timeadded']);
Print "<br><b>";
Print $messages['avi_name'];
Print "</b> (";
Print $messages['avi_id'];
Print ")<br>";
Print "Into <i>";
Print $messages['dropbox_name'];
Print "</i><br>Location: "; 
Print "<a href=http://slurl.com/secondlife/SJSU%20SLIS/";
Print $messages['x']."/".$messages['y']."/".$messages['z'];
Print ">";
Print "SJSU%20SLIS/".$messages['x']."/".$messages['y']."/".$messages['z'];
Print "</a>";
Print "<br><br>----------------------<br>";
}
