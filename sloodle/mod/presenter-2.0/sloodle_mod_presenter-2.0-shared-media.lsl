...
update_image_display()
{
    ...
    llSetPrimMediaParams( 2, [ PRIM_MEDIA_CONTROLS, PRIM_MEDIA_CONTROLS_MINI, PRIM_MEDIA_CURRENT_URL, curslidesource, PRIM_MEDIA_AUTO_PLAY, 1, PRIM_MEDIA_AUTO_SCALE, 1, PRIM_MEDIA_PERMS_INTERACT, PRIM_MEDIA_PERM_NONE, PRIM_MEDIA_PERMS_CONTROL, PRIM_MEDIA_PERM_NONE ] );
...
// SLOODLE LSL Script Subversion Location: mod/presenter-2.0/sloodle_mod_presenter-2.0-shared-media.lsl 
