...
list locstrings = [
    //  MetaGloss
    "picturegloss:ready", "Sloodle PictureGloss: {{0}}\nChat \"{{1}}\" then a term to search glossary", // Parameters: glossary name, and chat prefix command
    "picturegloss:idle", "Sloodle PictureGloss: {{0}}\nDEACTIVATED: touch me to re-activate", // Parameter: name of glossary
    "picturegloss:checking", "Checking Moodle glossary...",
    "picturegloss:checkok", "Successfully checked glossary: \"{{0}}\"", // Parameter: glossary name
    "picturegloss:searching", "Sloodle PictureGloss: {{0}}\nSearching...", // Parameter: glossary name
    "picturegloss:objChat", "Object Chat is now turned: {{0}}", // On or Off
    "picturegloss:ctrlmenu", "Please select:\n1) to turn Object chat ON\n2) to turn Object chat OFF", // On or Off    
    "picturegloss:numdefs", "Number of definitions found for \"{{0}}\": {{1}}" // Parameters: search term, and number of occurrences
